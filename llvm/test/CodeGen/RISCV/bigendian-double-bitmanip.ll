...
; RV32IFD-BE:       # %bb.0:
; RV32IFD-BE-NEXT:    slli a1, a1, 1
; RV32IFD-BE-NEXT:    srli a1, a1, 1
; RV32IFD-BE-NEXT:    ret
...
; RV32IFD-BE-NEXT:    sw a3, 8(sp)
; RV32IFD-BE-NEXT:    sw a2, 12(sp)
; RV32IFD-BE-NEXT:    fld fa5, 8(sp)
; RV32IFD-BE-NEXT:    sw a1, 8(sp)
; RV32IFD-BE-NEXT:    sw a0, 12(sp)
; RV32IFD-BE-NEXT:    fld fa4, 8(sp)
; RV32IFD-BE-NEXT:    fsgnj.d fa5, fa4, fa5
; RV32IFD-BE-NEXT:    fsd fa5, 8(sp)
; RV32IFD-BE-NEXT:    lw a1, 8(sp)
; RV32IFD-BE-NEXT:    lw a0, 12(sp)
; RV32IFD-BE-NEXT:    addi sp, sp, 16
; RV32IFD-BE-NEXT:    ret
